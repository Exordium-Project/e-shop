...
2.2 From hamburger menu in the top left corner "File -> import" select **database / mock_data_brands-types-products.postman_collection.json**
...
3.2 Start server in development mode
